...
This project was created with Create React App and serves as the frontend for the OctoFit Tracker application.

## Project Notes

- Bootstrap is installed and imported at the top of `src/index.js`.
